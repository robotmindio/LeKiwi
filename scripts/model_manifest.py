...
def snapshot(root):
    inputs = [
        ...
        for path in (
            ...
            "cad/upstream/RobotSkin/scad/parts/through_plate_12x10.scad",
            "cad/upstream/RobotSkin/scad/parts/rpi5_usb_carrier.scad",
            "cad/accessories/rpi5_table_installed.scad",
            ...
            "cad/chassis_rod_positions.json",
