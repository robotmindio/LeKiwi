...
Verified: native wrist STEP-fidelity checks, shoulder datum preservation and
propagation of a 20 mm assembly edit, Xacro semantics, chassis mesh fidelity,
native part trees and accessory source checks. Full `verify_robot.sh` is
finishing the remaining reference/manufacturing checks.
